...
public class TimelineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Recycler view setup (configure the recycler view): layout manager and the adapter
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // Must return true for the menu to display
        return true;
    }
    ...
    private void populateHomeTimeline() {
        // Call the API method using the TwitterClient
                ...
                try {
                    ...
                    AsyncTask.execute(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // insert users first - users need to populated in the user table so the foreign key connection can work
